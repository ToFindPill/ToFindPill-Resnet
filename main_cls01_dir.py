...
class Dataset_Dir(Dataset):
    def __init__(self, args, dir_dataset, transform=None, target_transform=None, run_phase='valid'):
        self.args = args
...
if __name__ == '__main__':
    ...
    dir_testimage = r'/data_2/ace_minjae/proj_pill/proj_pill/dir_testimage'
